...
<a href="./BoardForm.do" style="text-decoration: none">글작성</a> <br>
글갯수 : ${listcount}개 <br>
...
<table border=1 width=700 align="center">
	...
	<tr>
		...
		<td>
			...
			<a href="BoardDetailAction.do?board_num=${b.board_num}&page=${page}" style="text-decoration: none">
				${b.board_subject}</a>
		</td>
		<td>${b.board_name}</td>
		<td>
			<fmt:formatDate value="${b.board_date}" 
							pattern="yyyy-MM-dd HH:mm:ss E요일"/>
		</td>
